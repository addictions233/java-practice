...
//            sqlSession.commit();
            ...
            // 3、执行SQL
          sqlSession.insert("com.one.mybatisplus.mapper.UserMapper.insertUser", new TbUser("张三", 18));
          sqlSession.insert("com.one.mybatisplus.mapper.UserMapper.insertUser", new TbUser("李四", 19));
          sqlSession.insert("com.one.mybatisplus.mapper.UserMapper.insertUser", new TbUser("王五", 20));
