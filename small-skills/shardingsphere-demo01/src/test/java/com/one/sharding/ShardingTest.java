...
import com.one.sharding.entity.Course;
import com.one.sharding.mapper.CourseMapper;
...
//        wrapper.eq("cid",901136075815124993L);
...
//        wrapper.orderByDesc("user_id");
    ...
    public void queryCourseRange(){
        ...
        wrapper.between("cid",901136075815124993L,901136075966119937L);
        List<Course> courses = courseMapper.selectList(wrapper);
        courses.forEach(course -> System.out.println(course));
    }
    ...
    public void queryCourseComplexSimple(){
        QueryWrapper<Course> wrapper = new QueryWrapper<Course>();
//        wrapper.orderByDesc("user_id");
        wrapper.in("cid",901136075815124993L,901136074338729984L);
        wrapper.eq("user_id",1001L);
        List<Course> course = courseMapper.selectList(wrapper);
        //select * from couse where cid in (xxx) and user_id between(8,3)
